        ...
        if (box.receiver.toLowerCase() === accounts[0].toLowerCase()) {
          ...
          if (box.claimed) {
            ...
            claimedBoxes.push({
              id: i,
              ...box,
              assetUrl: `https://gateway.pinata.cloud/ipfs/${box.assetUrl.replace('ipfs://', '')}`
            });
          } else {
            unclaimedCount++;
          }
        ...
        <div className="box-container">
          {claimedBoxes.map((box, index) => (
            <div className="box-item" key={index}>
              ...
              <div className="box-content"><strong>Asset:</strong> <a href={box.assetUrl} target="_blank" rel="noopener noreferrer">{box.assetUrl}</a></div>
